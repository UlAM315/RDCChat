...
<div class="messageBoxOuter clearfix">
  <div class="messageBox">
    ...
    <div class="messageTop">
      <div class="topLeft">
        <h1>${myGroupAndGroup.myGroupName}</h1><!-- 群名字 -->
        <span>※群成员</span>
      </div>
      <div class="avatar">
    ...
    <div class="messageBottom">
      <input type="text" class="signContent" id="myGroupName" value="${myGroupAndGroup.myGroupName}">
      <span class="hateIt"><a id="leave">退出该群</a></span>
    </div>
    <div>
      <br>
...
<script>
  ...
  signContent.onblur=function(){
    ...
    var myGroupName = $("#myGroupName").val();
    var groupId = $("#groupId").val();
    if (myGroupName!=''&&myGroupName!=null){
      $.post("MyFriends/memberChangeGroupName",{myGroupName: myGroupName,groupId:groupId},function (info){
        if (info.flag){
          alert("修改群昵称成功！");
        }else {
          alert("修改失败！");
  ...
  $("#leave").click(function (){
    var groupId = $("#groupId").val();
    if (confirm("确定要退出群聊吗？")){
      $.post("MyFriends/leaveGroup",{groupId:groupId},function (info){
        if (info.flag){
          alert("退群成功！");
        }else {
          alert("退群失败！");
