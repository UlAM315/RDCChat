...
<head>
  ...
  <title>RDCChatGroupMessage</title>
  <%
...
<input type="text" id="groupId" value="${myGroupAndGroup.groupId}" hidden="hidden">
...
<div class="messageBoxOuter clearfix">
  <div class="messageBox">
    ...
    <div class="messageTop">
      <div class="topLeft">
        <h1><input type="text" class="signContent" id="groupName" value="${myGroupAndGroup.myGroupName}"></h1><!-- 群名字 -->
        <span>※我就是群主</span>
      </div>
      <div class="avatar">
        <img src="${myGroupAndGroup.avatarImg}">
      </div>
    </div>
    <div class="messageBottom">
      <span class="hateIt"><a id="invite">邀请好友</a></span>
      <span class="goDie"><a id="groupManage">群管理</a></span>
    </div>
    <div>
      <br>
...
<script>
  ...
  signContent.onblur=function(){
    ...
    if (groupName!=''&&groupName!=null){
      $.post("MyFriends/ownerChangeGroupName",{groupName: groupName,groupId:groupId},function (info){
        if (info.flag){
          alert("修改群名称成功！");
        }else {
          alert("修改失败！");
  ...
  $("#invite").click(function (){
    var groupId = $("#groupId").val();
    location.href="${pageContext.request.contextPath}/MyFriends/actionInviteFriendsToGroup?groupId="+groupId;//记得把groupId也传过去
  });

  $("#groupManage").click(function (){
    var groupId = $("#groupId").val();
    location.href="${pageContext.request.contextPath}/MyFriends/actionGroupManagment?groupId="+groupId;//记得把groupId也传过去
  });
