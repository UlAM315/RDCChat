...
<head>
    ...
    <title>RDCChatGroupManagment</title>
    <%
        ...
        $(function(){
            ...
            $("#dismiss").click(function (){
                ...
                if (confirm("你确定要解散该群吗？")){
                    $.post("MyFriends/dismissGroup",{groupId: groupId},function (info){
                        if (info.flag){
                            alert("解散成功！");
                        }else {
                            alert("解散失败！");
...
<div class="container">
    <strong style="color: purple">${kick_msg}</strong>
    <h3 style="text-align: center">群管理</h3>



    <form id="form" action="${pageContext.request.contextPath}/MyFriends/kickPeople" method="post">
        <input type="text" id="groupId" value="${groupId}" name="groupId" hidden="hidden">
        <div style="float: right;margin: 5px;">
            <button type="submit" id="tPeople">踢人</button>
            <button type="button" id="dismiss">解散该群</button>
        </div>
