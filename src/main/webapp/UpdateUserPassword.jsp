    ...
    <script>
        ...
        $(function () {
            ...
            $("#updatePasswordForm").submit(function(){
                    ...
                    //修改密码
                $.post("Users/updateUserPassword", {userPassword:userPassword}, function (data) {
                    //处理服务器响应的数据
                    if (data.flag) {
                        alert("修改成功，快去登录吧~");
...
<div class="input-box">
    ...
    <form id="updatePasswordForm" action="#" method="post">
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="userPassword" name="userPassword" placeholder="请输入新密码(长度6到20位)">
        </div>
        <button type="submit" class="btn btn-default" id="update">确认修改</button><br>
