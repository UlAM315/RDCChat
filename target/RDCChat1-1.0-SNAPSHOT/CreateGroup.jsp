...
<div class="container">
    <strong style="color: purple">${createGroup_msg}</strong>
    <h3 style="text-align: center">拉群</h3>



    <form id="form" action="${pageContext.request.contextPath}/MyFriends/createGroup" method="post">
        <div class="form-group">
            <label for="groupName">群名</label>
            <input type="text" name="groupName" class="form-control" id="groupName" placeholder="请输入群名">
        </div>
        <div style="float: right;margin: 5px;">

            <button type="submit"  id="createGroup">拉群</button>
