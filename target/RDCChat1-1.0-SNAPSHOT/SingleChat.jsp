...
<head>
    ...
    <script type="text/javascript">
        function setReceiver(receiver) {
            ...
            document.getElementById("reply-to").innerHTML = "接收人：" + receiver;
        }
    </script>
...
<div class="chatBox" style="display: block;">
    ...
    <input hidden="hidden" value="${receiver}" id="receiver">
...
<script type="text/javascript">
    ...
    if ('WebSocket' in window) {
        websocket = new WebSocket("ws://localhost:8080/RDCChat1/webSocketSingleChat?userName="+userName+"&receiver="+receiver);
    }
    else {
